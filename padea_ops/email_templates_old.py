...
def render_caterer_email(client, generated) -> str:
    ...
    school_name = school.get("name") or order.get("school_id")
    ...
    exception_lines = [f"- [{e['severity'].upper()}] {e['exception_type']}: {e['message']}" for e in generated.exceptions if e["severity"] != "info"]
...
def write_email_draft(client, generated, output_dir: Path) -> Path:
    ...
    school, caterer = generated.email_context.get("school") or {}, generated.email_context.get("caterer") or {}
    filename = f"{generated.order['delivery_date']}_{slugify(school.get('name') or generated.order['school_id'])}_{slugify(caterer.get('name') or generated.order['caterer_id'])}.md"
...
def write_distribution_sheet(generated, output_dir: Path) -> Path:
    ...
    filename = f"{generated.order['delivery_date']}_{slugify(school.get('name') or generated.order['school_id'])}_distribution.csv"
    path = output_dir / filename
    with path.open("w", newline="", encoding="utf-8") as f:
        ...
        for row in generated.student_map:
            ...
            writer.writerow({
                ...
                "school": school.get("name") or generated.order["school_id"],
